...
def update():
    ...
    if (args.tor == False):
        ...
        r = requests.get("https://www.cloudflare.com/ips-v4", headers=headers,
                         cookies={'__cfduid': "d7c6a0ce9257406ea38be0156aa1ea7a21490639772"},
                         stream=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--target", help="target url of website", type=str, default="monopoly-one.com")
    parser.add_argument("-T", "--tor", dest="tor", action="store_true", help="enable TOR routing", default=True)
